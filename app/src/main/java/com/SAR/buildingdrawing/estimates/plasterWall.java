...
public class plasterWall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plaster_wall);
        
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Plaster Wall");
        ...
        calculate_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(room_length.getText().toString())){
                    Toast.makeText(plasterWall.this, "Room Length cannot be null",Toast.LENGTH_SHORT).show();
                ...
                if(TextUtils.isEmpty(room_width.getText().toString())){
                    Toast.makeText(plasterWall.this, "Room Width cannot be null",Toast.LENGTH_SHORT).show();
                ...
                if(TextUtils.isEmpty(room_height.getText().toString())){
                    Toast.makeText(plasterWall.this, "Room Height cannot be null",Toast.LENGTH_SHORT).show();
                ...
                LayoutInflater inflater = (LayoutInflater) plasterWall.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                new AlertDialog.Builder(plasterWall.this).setView(formElementsView)
